...
Aplicação web para gestão de academia, com áreas para aluno e instrutor, telas Thymeleaf e com interface voltada para Desktop. O projeto utiliza Spring Boot, Spring Data JPA, Spring Security e MySQL.
